...
export async function loadWorkspace() {
  ...
  const milestones = await db.select(`SELECT t.id, t.project_id, t.title, t.notes, t.status_code,
    t.completed_at, t.archived_at, t.due_date, sm.label AS status_label
    ...
    WHERE t.parent_id IS NULL ORDER BY t.sort_order, t.id`);
