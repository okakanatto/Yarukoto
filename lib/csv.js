...
export const TASK_CSV_FIELDS = [
    ...
    'waiting_on', 'review_date', 'next_task_id', 'last_opened_at', 'next_step', 'work_started_at',
];
...
export async function importTasksCSV(db, text) {
    ...
    const prepared = rows.map(row => {
        ...
        for (const field of ['start_date', 'due_date', 'today_date', 'notes', 'created_at', 'updated_at', 'completed_at', 'archived_at', 'capture_text', 'source_ref', 'waiting_on', 'review_date', 'last_opened_at', 'next_step', 'work_started_at']) {
